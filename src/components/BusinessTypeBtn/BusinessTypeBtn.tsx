...
const BusinessTypeBtn = ({ title, active, onPress }: BusinessTypeCardProps) => {
  return (
    <button
      onClick={onPress}
      className={`flex items-center justify-center xl:rounded-xl xl:text-xs xl:leading-[19.2px] min-w-[146.67px] h-[44px] text-sm font-sf leading-[22.4px] xl:border-[1px] xl:border-border ${
        active
